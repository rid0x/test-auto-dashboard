...
export type ProjectName = 'getprice' | 'willsoor' | 'pieceofcase' | '4szpaki' | 'moncredo' | 'pierrerene' | 'abazur' | 'cornette' | 'entelo' | 'distripark' | 'elakiernik' | 'hulajnogimicro' | 'bladeville' | 'test';
