...
test.describe('4szpaki - Broken Links Tests @links', () => {
  ...
  test('product page links return 200', async ({ page, request }) => {
    await page.goto(`${BASE}${szpakiConfig.product.url}`, { waitUntil: 'domcontentloaded' });
  ...
  test('category product links return 200', async ({ page, request }) => {
    await page.goto(`${BASE}${szpakiConfig.category.url}`, { waitUntil: 'domcontentloaded' });
