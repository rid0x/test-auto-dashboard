...
const BASE = willsoorConfig.baseUrl;

test.describe('Willsoor - SEO Tests @seo', () => {
  ...
  test.describe('Meta Tags', () => {
    ...
    test('product page has meta title', async ({ page }) => {
      await page.goto(`${BASE}${willsoorConfig.product.url}`, { waitUntil: 'domcontentloaded' });
      const title = await page.title();
    ...
    test('category page has meta title', async ({ page }) => {
      await page.goto(`${BASE}${willsoorConfig.category.url}`, { waitUntil: 'domcontentloaded' });
      const title = await page.title();
  ...
  test.describe('Headings & Structure', () => {
    ...
    test('product images have alt attributes', async ({ page }) => {
      await page.goto(`${BASE}${willsoorConfig.product.url}`, { waitUntil: 'load' });
