...
test.describe('Getprice - Homepage @homepage @e2e', () => {
  ...
  test('should load without console errors', async ({ page }) => {
    ...
    await page.goto('https://getprice.pl', { waitUntil: 'load' });
  ...
  test('should be responsive - mobile viewport', async ({ page }) => {
    ...
    await page.goto('https://getprice.pl', { waitUntil: 'domcontentloaded' });
