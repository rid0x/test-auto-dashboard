...
test.describe('Entelo - Visual Regression @visual', () => {

  test.beforeEach(async ({ page }) => {
    // Zamknij cookie consent
    try { await page.click('#CookiebotDialogBodyLevelButtonLevelOptinAllowAll', { timeout: 3000 }); } catch {}
