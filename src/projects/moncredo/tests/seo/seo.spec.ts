...
const BASE = moncredoConfig.baseUrl;

test.describe('Moncredo - SEO Tests @seo', () => {
  ...
  test.describe('Meta Tags', () => {
    ...
    test('product page has meta title', async ({ page }) => {
      await page.goto(`${BASE}${moncredoConfig.product.url}`, { waitUntil: 'domcontentloaded' });
      const title = await page.title();
    ...
    test('category page has meta title', async ({ page }) => {
      await page.goto(`${BASE}${moncredoConfig.category.url}`, { waitUntil: 'domcontentloaded' });
      const title = await page.title();
  ...
  test.describe('Headings & Structure', () => {
    ...
    test('product images have alt attributes', async ({ page }) => {
      await page.goto(`${BASE}${moncredoConfig.product.url}`, { waitUntil: 'load' });
