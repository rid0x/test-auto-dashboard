...
test.describe('Cornette - Category @category @e2e', () => {
  ...
  test('should apply filter and update results', async ({ page }) => {
    // Cornette uses swatch-layered filters (color/size swatches)
  ...
  test('should display product names and prices', async ({ page }) => {
    ...
    // Cornette uses: strong.product-item-name > a.product-item-link > h2
