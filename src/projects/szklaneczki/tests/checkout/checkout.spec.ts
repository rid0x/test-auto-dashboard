...
test.describe('Szklaneczki - Checkout @checkout @e2e', () => {
  ...
  test('should display shipping methods', async ({ checkoutPage, page }) => {
    ...
    await checkoutPage.fillShippingAddress({
      email: 'guest-test@Szklaneczki.pl',
      firstName: 'Aurora',
      lastName: 'Bot',
      street: 'Testowa 2',
      city: 'Białystok',
  ...
  // @desc: Krok podsumowania wyswietla sekcje platnosci (Szklaneczki redirect po kliknieciu "Kupuje i place")
  test('should display payment methods', async ({ checkoutPage, page }) => {
    ...
    // Szklaneczki: payment is handled via external gateway (redirect after "Kupuję i płacę")
