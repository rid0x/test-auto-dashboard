...
test.describe('Szklaneczki - Registration @registration @e2e', () => {
  ...
  test('should register with valid data', async ({ registrationPage, page, config }) => {
    // Szklaneczki has reCAPTCHA on registration
    test.skip(true, 'reCAPTCHA blokuje rejestracje na Szklaneczki');
  });
