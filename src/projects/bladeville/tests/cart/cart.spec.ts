...
test.describe('Bladeville - Cart @cart @e2e', () => {
  ...
  // @desc: Zwieksenie ilosci produktu w koszyku
  ...
  // @desc: Zmniejszenie ilosci produktu w koszyku do 1
  ...
  // @desc: Usuniecie produktu z koszyka
